...
import com.github.seckillsystem.common.security.component.*;
 ...
 *对SpringSecurity的扩展，支持自定义白名单资源路径和查询用户逻辑
 * create by bu 2020/5/23
 */
@Configuration
@EnableWebSecurity
...
//        }
    ...
    @Bean
    public HttpAccessDeniedHandler httpAccessDeniedHandler() {
